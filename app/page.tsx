...
export default function LoginPage() {
  return (
    <div className={twMerge(
      "grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 min-h-screen w-full items-center",
      "font-sans dark:bg-black gap-8"
    )}>
      <div className="min-h-screen w-full bg-[linear-gradient(140deg,lightgray_10px,transparent_2px),linear-gradient(145deg,#80808010_10px,transparent_2px)] bg-size-[15px_15px] mask-image-[radial-gradient(ellipse_130%_130%_at_50%_50%,#000_80%,transparent_100%)] bg-blend-lighten animate-[rotatedGrid_20s_linear_infinite]">
        <div className="mt-10 tracking-wide drop-shadow-[2px_2px_0_rgba(0,0,0,0.2)] bg-linear-to-r from-indigo-500 to-orange-400 text-transparent bg-clip-text">
          <div className="w-full h-full p-5 flex justify-around items-center">
        ...
        <Flex justifycontent="between" items="center">
          <Card className={twMerge("w-full shadow-md hover:shadow-md rounded-md")}>
            <form className="flex flex-col gap-8 p-10">
              ...
              <div className="flex justify-between items-center">
                <Link href="/auth/create-account" className="text-indigo-500 font-medium text-sm cursor-pointer">
                  Create Account
                </Link>
                <Link href="/auth/forget-password" className="text-indigo-500 font-medium text-sm cursor-pointer">
                  Forget Password
                </Link>
              </div>
            </form>
